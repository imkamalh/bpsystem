<!DOCTYPE html>
    ...
    <head>
        ...
        <!-- Vendor CSS -->
        <link href="{{URL::asset('assets/vendors/bower_components/animate.css/animate.min.css')}}" rel="stylesheet">
        <link href="{{URL::asset('assets/vendors/bower_components/google-material-color/dist/palette.css')}}" rel="stylesheet">
        <link href="{{URL::asset('assets/vendors/bower_components/material-design-iconic-font/dist/css/material-design-iconic-font.min.css')}}" rel="stylesheet">
    ...
    <body>
        <div class="login" data-lbg="teal">
            <!-- Login -->
            <form class="l-block toggled" action="{{url('login')}}" method="POST" id="l-login">
            {!! csrf_field() !!}
                ...
                <div class="lb-body">
                    <div class="form-group fg-float">
                        <div class="fg-line">
                            ...
                            <label class="fg-label">Username/Email Address</label>
                        </div>
                    </div>
                    ...
                    <button class="btn palette-Teal bg">Log in</button>
        ...
        <script src="{{URL::asset('assets/vendors/bower_components/jquery/dist/jquery.min.js')}}"></script>
        <script src="{{URL::asset('assets/vendors/bower_components/bootstrap/dist/js/bootstrap.min.js')}}"></script>
        <script src="{{URL::asset('assets/vendors/bower_components/Waves/dist/waves.min.js')}}"></script>
